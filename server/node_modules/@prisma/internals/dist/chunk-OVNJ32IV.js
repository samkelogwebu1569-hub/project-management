...
var chunk_OVNJ32IV_exports = {};
__export(chunk_OVNJ32IV_exports, {
  GetConfigError: () => GetConfigError,
  getConfig: () => getConfig
});
module.exports = __toCommonJS(chunk_OVNJ32IV_exports);
...
[Context: getConfig]`;
    super((0, import_chunk_W4PXBRCB.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        return import_chunk_JXCQ6QEO.prismaSchemaWasm.get_config(params);
      },
      (e) => ({
        type: "wasm-error",
