...
var chunk_ZRVGF6PQ_exports = {};
__export(chunk_ZRVGF6PQ_exports, {
...
module.exports = __toCommonJS(chunk_ZRVGF6PQ_exports);
...
var import_chunk_4NBMRBMA = require("./chunk-4NBMRBMA.js");
var import_chunk_MDAN6X4P = require("./chunk-MDAN6X4P.js");
var import_chunk_PC5G4IPR = require("./chunk-PC5G4IPR.js");
var import_chunk_HJ4SIXGI = require("./chunk-HJ4SIXGI.js");
var import_chunk_B7O5EM2H = require("./chunk-B7O5EM2H.js");
...
async function formatSchema({ schemas }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(() => {
      import_chunk_B7O5EM2H.prismaSchemaWasm.debug_panic();
    });
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(() => {
    ...
    const lintDiagnostics2 = (0, import_chunk_MDAN6X4P.lintSchema)({ schemas: formattedMultipleSchemas2 });
    return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
  });
  const lintWarnings = (0, import_chunk_MDAN6X4P.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_B7O5EM2H.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function processSchemaResult({
  ...
  const configFromPsl = await (0, import_chunk_HJ4SIXGI.getConfig)({ datamodel: schemaResult.schemas });
...
async function getGenerators(options) {
  ...
  const dmmf = await (0, import_chunk_4NBMRBMA.getDMMF)({ datamodel: schemaContext.schemaFiles });
...
You need to define \`output\` in the generator block in the schema file.`
        ...
        const datamodel = (0, import_chunk_PC5G4IPR.mergeSchemas)({ schemas: schemaContext.schemaFiles });
        const options2 = {
          datamodel,
