...
var chunk_KARIQA23_exports = {};
__export(chunk_KARIQA23_exports, {
  getEnginesInfo: () => getEnginesInfo,
  resolveEngine: () => resolveEngine
});
module.exports = __toCommonJS(chunk_KARIQA23_exports);
...
async function resolveEngine(binaryName) {
  ...
  const enginePathEither = await (0, import_function2.pipe)(
    pathFromEnvOption,
    fold(
      () => (0, import_chunk_WMYLXKKD.safeResolveBinary)(binaryName),
  ...
  const versionEither = await (0, import_function2.pipe)(
    ...
    (0, import_chunk_5DBOS77Y.chain)((enginePath) => {
      return (0, import_chunk_6I5EQPM7.safeGetEngineVersion)(enginePath, binaryName);
    })
  )();
  const engineInfo = {
