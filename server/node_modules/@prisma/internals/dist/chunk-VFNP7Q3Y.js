...
function delay(timeout, scheduler = setTimeout) {
  return new Promise((resolve3) => scheduler(resolve3, timeout));
}
...
var chai_exports = {};
(0, import_chunk_4VNS5WPM.__export)(chai_exports, {
  Assertion: () => Assertion,
...
__export22(check_error_exports, {
...
function parseFFOrSafariStackTrace(stack) {
  return stack.split("\n").map((line) => parseSingleFFOrSafariStack2(line)).filter(notNullish);
}
function parseV8Stacktrace(stack) {
  return stack.split("\n").map((line) => parseSingleV8Stack2(line)).filter(notNullish);
}
      ...
      for (i2 = 0, l = clock.methods.length; i2 < l; i2++) {
        ...
        if (clock.timersPromisesModuleMethods !== void 0) {
          if (nameOfMethodToReplace === "setTimeout") {
            ...
            timersPromisesModule.setTimeout = (delay2, value, options = {}) => new Promise((resolve3, reject) => {
              const abort = () => {
            ...
            timersPromisesModule.setImmediate = (value, options = {}) => new Promise((resolve3, reject) => {
              const abort = () => {
                options.signal.removeEventListener(
                  "abort",
                  abort
