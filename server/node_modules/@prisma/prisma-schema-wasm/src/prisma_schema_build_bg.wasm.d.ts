...
export const __wbg_dmmfbuffer_free: (a: number, b: number) => void;
export const code_actions: (a: number, b: number, c: number, d: number) => [number, number];
export const debug_panic: () => void;
export const dmmfbuffer_is_empty: (a: number) => number;
export const dmmfbuffer_len: (a: number) => number;
export const dmmfbuffer_read_chunk: (a: number, b: number, c: number) => [number, number, number, number];
...
export const get_dmmf_buffered: (a: number, b: number) => [number, number, number];
